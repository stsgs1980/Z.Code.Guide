...
export const zcodeNavigation = [
  // === Новые вводные секции (§1-3) ===
  { id: "what-is-zcode", num: "01", title: "Что такое ZCode", icon: "Zap" },
  { id: "installation", num: "02", title: "Установка", icon: "Download" },
  { id: "api-keys", num: "03", title: "API Key Setup", icon: "Key" },
  // === Оригинальные секции (перенумерованы 04-15) ===
  { id: "feedback", num: "04", title: "Feedback", icon: "MessageCircle" },
  { id: "agents", num: "05", title: "Agents", icon: "Bot" },
  { id: "edit-history", num: "06", title: "Edit History", icon: "History" },
  { id: "commands", num: "07", title: "Commands", icon: "Terminal" },
  { id: "plugin", num: "08", title: "Plugins", icon: "Puzzle" },
  { id: "mcp", num: "09", title: "MCP Services", icon: "Server" },
  { id: "skill", num: "10", title: "Skills", icon: "Sparkles" },
  { id: "agent-framework", num: "11", title: "Agent Framework", icon: "Cpu" },
  { id: "safety-confirm", num: "12", title: "Safety Confirm", icon: "Shield" },
  { id: "ade-tools", num: "13", title: "ADE Tools", icon: "Wrench" },
  { id: "shortcuts", num: "14", title: "Shortcuts", icon: "Keyboard" },
  { id: "qa", num: "15", title: "Q&A", icon: "HelpCircle" },
  // === Секции из ZCode 3.0 Guide (перенумерованы 16-25) ===
  { id: "interface", num: "16", title: "Интерфейс", icon: "Layout" },
  { id: "agent-workflow", num: "17", title: "Работа с Agent", icon: "Play" },
  { id: "execution-modes", num: "18", title: "Режимы выполнения", icon: "ToggleLeft" },
  { id: "goal-mode", num: "19", title: "Goal Mode", icon: "Target" },
  { id: "remote-control", num: "20", title: "Remote Control", icon: "Smartphone" },
  { id: "bot-channel", num: "21", title: "Bot Channel", icon: "MessageSquare" },
  { id: "interface-settings", num: "22", title: "Настройка интерфейса", icon: "Settings" },
  { id: "usage-stats", num: "23", title: "Usage Stats", icon: "BarChart3" },
  { id: "coding-tool-helper", num: "24", title: "Coding Tool Helper", icon: "Terminal" },
  { id: "new-features", num: "25", title: "Новое в 3.0", icon: "Rocket" },
  { id: "best-practices", num: "26", title: "Лучшие практики", icon: "Lightbulb" },
  { id: "cheatsheet", num: "27", title: "Шпаргалка", icon: "BookOpen" },
  { id: "changelog", num: "28", title: "История релизов", icon: "Clock" },
];
